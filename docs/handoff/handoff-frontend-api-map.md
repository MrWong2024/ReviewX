...
| `sendPasswordResetCode` | `POST /auth/password-reset/code` | `frontend/src/features/auth/api.ts` | implemented |
| `resetPasswordWithSms` | `POST /auth/password-reset` | `frontend/src/features/auth/api.ts` | implemented |
