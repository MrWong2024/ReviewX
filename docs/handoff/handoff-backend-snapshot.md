...
- 当前 `scripts/sync-indexes.ts` 显式注册 `User`、`Session`、`Batch`、`Dictionary`、`TreeDictionary`、`Organization`、`ReviewScheme`、`Project` schema，并同步对应集合索引
...
- 当前未实现 Excel 导入、项目负责人材料上传、专家评分、AI 合议、申诉、甲方看板或腾讯会议集成
