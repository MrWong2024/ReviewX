...
本路线图描述的是截至“ReviewX 前端第六阶段：评审负责人合议工作台”完成，并完成“ReviewX 小修：AdminShell 增加返回工作台入口”“ReviewX 小修：普通字典类型筛选固定化并默认选中项目状态”“ReviewX 小修：普通字典固定类型恢复评审等级”“ReviewX 小修：树形字典列表行内移除重复树类型展示”“ReviewX 小修：树形字典默认仅展示第一层并支持按需展开”“ReviewX 小修：树形字典新增编辑弹窗父节点选择体验优化”“ReviewX 小修：统一增强原生 Select 中树形选项缩进显示”“ReviewX 小修：专家任务评审负责人多角色用户名称解析修复”“ReviewX 小修：专家评分提交增加评审时间窗口校验”“ReviewX 小修：专家可删除本人未提交评分草稿”和“ReviewX 小修：专家分配移除规则收紧为无评分记录才可物理删除”后的项目状态。
...
- 评审负责人合议工作台前端接入：
  ...
  - 项目详情新增评审组织 / 专家分配区块，可查看已分配专家和候选专家，并支持追加、替换和移除无评分记录专家
...
阶段外小修：ReviewX 小修：专家分配移除规则收紧为无评分记录才可物理删除（已完成）
   ...
   - 任意 `draft/submitted/returned` 专家评分记录都会阻止单个移除和 replace 隐含移除，返回 `409 EXPERT_ASSIGNMENT_HAS_REVIEW_RECORD`
...
阶段外小修：ReviewX 第六阶段小修：评审负责人工作台权限收紧、专家分配接入与合议确认表单清理（已完成）
   ...
   - 评审负责人项目详情新增专家分配区块，支持已分配专家、候选专家、追加、替换和移除无评分记录专家
...
- 当前建议下一步是“ReviewX 前端第七阶段：申诉闭环”；如果演示优先级转向监管，也可以先做“甲方看板后端 API + 前端看板雏形”。
