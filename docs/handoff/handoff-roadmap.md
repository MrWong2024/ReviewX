...
- 当前短哈希基线：`dd869d4`；演示版收口与生产预检已完成，服务器试跑和甲方演示基本就绪。
...
6. 后续按实际需求进入部署维护、小范围演示打磨或暂缓能力专项开发：腾讯会议直播 / 推流 / 回看 / 会议 API 集成、真实 AI 汇总、文件预览 / 在线转换、审计日志、用户自助改密 / 短信验证码、批量导入增强、权限矩阵配置仍暂缓。
...
- 当前阶段建议：演示版基础闭环已完成；后续按实际需求进入部署维护、小范围演示打磨或暂缓能力专项开发，不要把暂缓能力写成已完成能力。
