    ...
    <>
      <div className="page-title">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            className="inline-flex min-h-10 items-center rounded-lg bg-gradient-to-r from-indigo-600 to-cyan-600 px-4 py-2 text-sm font-bold text-white shadow-sm transition hover:text-white hover:shadow-md focus-visible:text-white active:text-white"
