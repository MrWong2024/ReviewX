...
type ProjectOwnerShellProps = {
  children: ReactNode;
};

const NAV_ITEMS = [
  { href: '/project-owner', icon: '◇', label: '概览' },
  { href: '/project-owner/projects', icon: '01', label: '我的项目' },
];

export function ProjectOwnerShell({ children }: ProjectOwnerShellProps) {
      ...
      <div className="rx-admin-bg flex min-w-0 flex-col">
        <header className="sticky top-0 z-30 flex min-h-16 flex-wrap items-center justify-between gap-3 border-b border-white/80 bg-white/80 px-6 py-3 shadow-sm backdrop-blur-xl">
          ...
          <div className="flex flex-wrap items-center justify-end gap-3">
            ...
            <Badge tone="primary">{ROLE_LABELS.project_owner}</Badge>
            <Link
